...
while True:
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            # Classify emotion (Inferencer.predict returns: key, display_name, confidence, emoji)
            emotion_key, emotion_label, emotion_confidence, emotion_emoji = emotion_inferencer.predict(face_img)
