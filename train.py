...
class Trainer:
    def __init__(self, save_path):
        ...
        self.train_dataset = CustomImageDataset(root_dir='./train_images', transform=self.transform)
        self.test_dataset = CustomImageDataset(root_dir='./test_images', transform=self.transform)
        ...
        print(self.model)
        self.model.head.fc = nn.Linear(512, 8)  # Modify the final layer for 8 classes
